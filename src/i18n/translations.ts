...
export const translations = {
  en: {
    ...
    auth: {
      ...
      loginSubtitle: 'Sign in to your Pet Pass Vienna account',
      signupTitle: 'Create your account',
      signupSubtitle: 'Join Pet Pass Vienna today',
      email: 'Email address',
      password: 'Password',
    ...
    pets: {
      ...
      addFirst: 'Add your first pet to get started!',
      confirmDelete: 'Are you sure you want to remove this pet?',
      petSaved: 'Pet saved successfully',
      petDeleted: 'Pet removed successfully',
    },
    ...
    card: {
      ...
      memberId: 'Member ID',
      scanQr: 'Show this QR code at any partner location',
      noCard: 'Subscribe to a plan to get your digital membership card.',
    },
    ...
    settings: {
      ...
      gdprDesc: 'I consent to the processing of my personal data as described in the Privacy Policy',
      marketingConsent: 'Marketing Communications',
      marketingDesc: 'I would like to receive news, offers, and updates via email',
    ...
    referral: {
      ...
      description: 'When a friend signs up with your code, you both get 1 month free!',
  ...
  de: {
    ...
    auth: {
      ...
      loginSubtitle: 'Melde dich bei deinem Pet Pass Vienna Konto an',
      signupTitle: 'Konto erstellen',
      signupSubtitle: 'Werde noch heute Mitglied bei Pet Pass Vienna',
      email: 'E-Mail-Adresse',
      password: 'Passwort',
      ...
      resetPasswordSubtitle: 'Gib dein neues Passwort unten ein',
      signIn: 'Anmelden',
      signUp: 'Registrieren',
      ...
      resetEmailSent: 'Prüfe deine E-Mails für den Link zum Zurücksetzen.',
    ...
    dashboard: {
      ...
      petCount: '{n} Haustier(e) registriert',
      noPets: 'Noch keine Haustiere registriert',
    },
    ...
    admin: {
      ...
      arpu: 'ARPU',
      ltv: 'LTV',
      trialConversion: 'Trial-Konversion',
      newSignups: 'Neue Anmeldungen',
      petsPerUser: 'Haustiere / Nutzer',
      waitlistSize: 'Wartelistengröße',
      revenueOverTime: 'Umsatz über Zeit',
      planDistribution: 'Tarifverteilung',
      recentSignups: 'Letzte Anmeldungen',
    ...
    pets: {
      ...
      noPets: 'Du hast noch keine Haustiere hinzugefügt.',
      addFirst: 'Füge dein erstes Haustier hinzu!',
      confirmDelete: 'Bist du sicher, dass du dieses Haustier entfernen möchtest?',
      petSaved: 'Haustier erfolgreich gespeichert',
      petDeleted: 'Haustier erfolgreich entfernt',
    },
    ...
    membership: {
      ...
      manageInStripe: 'Abrechnung verwalten',
      noPlan: 'Du hast noch keinen aktiven Tarif.',
      ...
      date: 'Datum',
      invoice: 'Rechnung',
      startTrial: '30-Tage-Testphase starten',
    },
    ...
    card: {
      ...
      scanQr: 'Zeige diesen QR-Code bei einem Partnerstandort',
      noCard: 'Schließe einen Tarif ab, um deine digitale Mitgliedskarte zu erhalten.',
    },
    ...
    settings: {
      ...
      gdprConsent: 'Einwilligung zur Datenverarbeitung',
      gdprDesc: 'Ich stimme der Verarbeitung meiner personenbezogenen Daten gemäß der Datenschutzerklärung zu',
      marketingConsent: 'Marketing-Kommunikation',
      marketingDesc: 'Ich möchte Neuigkeiten, Angebote und Updates per E-Mail erhalten',
      ...
      deleteConfirm: 'Gib LÖSCHEN ein, um zu bestätigen',
    ...
    referral: {
      ...
      description: 'Wenn ein Freund sich mit deinem Code anmeldet, bekommt ihr beide 1 Monat gratis!',
      referrals: 'Deine Empfehlungen',
      pending: 'Ausstehend',
