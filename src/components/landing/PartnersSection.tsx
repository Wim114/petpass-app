...
const PartnersSection: React.FC = () => {
  ...
  return (
    <section id="partners" className="py-12 sm:py-24 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="space-y-5 sm:space-y-8">
            ...
            <div className="flex items-center gap-3 sm:gap-4 p-4 sm:p-6 rounded-2xl sm:rounded-[2rem] bg-emerald-600 text-white">
              <div className="w-10 h-10 sm:w-12 sm:h-12 bg-white/20 rounded-full flex items-center justify-center shrink-0">
                <Star className="w-5 h-5 sm:w-6 sm:h-6 fill-current" />
              </div>
              <div className="min-w-0">
                <h4 className="font-bold text-sm sm:text-base">{t.partners.transparency}</h4>
                <p className="text-emerald-100 text-xs sm:text-sm">{t.partners.transparencyDesc}</p>
              </div>
            </div>
          </div>
