          ...
          {flowType === 'quick' && !submitted && (
            <div className="space-y-6">
              ...
              <div className="text-center">
                <button
                  type="button"
                  onClick={() => { setFlowType('survey'); setStep(1); }}
                  className="text-emerald-600 hover:text-emerald-700 font-medium text-sm underline underline-offset-4 transition-colors"
                >
